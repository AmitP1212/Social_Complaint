          ...
          <MDBRow className='g-0'>
            ...
            <MDBCol md='6'>
              <MDBCardBody className='d-flex flex-column'>
                ...
                <MDBInput onChange={ setValues } wrapperClass='mb-4' pattern='^(?=[a-zA-Z0-9._]{8,20}$)(?!.*[_.]{2})[^_.].*[^_.]$' label='Username' name='username' id='username' type='text' size="lg" />
                <MDBInput onChange={ setValues } wrapperClass='mb-4' pattern='^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&_])[A-Za-z\d@$!%*?&_]{8,10}$' label='Password' name='password' id='password' type='password' size="lg" />
